...
@XmlType(name = "SourceFileListType", namespace = "http://psi.hupo.org/ms/traml", propOrder = {
    "sourceFile"
})
public class SourceFileListType {

    @XmlElement(name = "SourceFile", namespace = "http://psi.hupo.org/ms/traml", required = true)
