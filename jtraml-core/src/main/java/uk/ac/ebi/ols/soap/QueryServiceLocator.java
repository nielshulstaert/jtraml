...
public class QueryServiceLocator extends org.apache.axis.client.Service implements uk.ac.ebi.ols.soap.QueryService {
    ...
    public uk.ac.ebi.ols.soap.Query getOntologyQuery() throws javax.xml.rpc.ServiceException {
    ...
    public uk.ac.ebi.ols.soap.Query getOntologyQuery(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            uk.ac.ebi.ols.soap.OntologyQuerySoapBindingStub _stub = new uk.ac.ebi.ols.soap.OntologyQuerySoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (uk.ac.ebi.ols.soap.Query.class.isAssignableFrom(serviceEndpointInterface)) {
                uk.ac.ebi.ols.soap.OntologyQuerySoapBindingStub _stub = new uk.ac.ebi.ols.soap.OntologyQuerySoapBindingStub(new java.net.URL(OntologyQuery_address), this);
                _stub.setPortName(getOntologyQueryWSDDServiceName());
                return _stub;
            }
