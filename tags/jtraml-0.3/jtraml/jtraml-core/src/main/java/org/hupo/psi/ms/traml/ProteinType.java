 ...
 *         &lt;element name="Sequence" type="{http://psi.hupo.org/ms/traml}SequenceType" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "ProteinType", namespace = "http://psi.hupo.org/ms/traml", propOrder = {
    "cvParam",
    "sequence"
})
public class ProteinType {
    ...
    @XmlElement(name = "Sequence", namespace = "http://psi.hupo.org/ms/traml")
